...
## MUSEUS E CULTURA
- Museu D. Diogo de Sousa: arqueologia de Bracara Augusta.
- Museu dos Biscainhos: palácio barroco com jardins.
- Museu da Imagem e Museu Nogueira da Silva.
- Theatro Circo: um dos mais belos teatros de Portugal (1915), programação regular.
- Casa Rolão, Palácio do Raio: fachadas emblemáticas de azulejo e barroco de André Soares.

## JARDINS E NATUREZA
- Jardim de Santa Bárbara: jardim icónico junto ao antigo Paço Episcopal, muito fotogénico.
- Parque da Ponte, Monte Picoto (vista sobre a cidade, atividades de aventura).
- Rio Este atravessa a cidade; a ~30 min está o Parque Nacional da Peneda-Gerês (escapadela de natureza).

## EVENTOS PRINCIPAIS (época habitual)
- Semana Santa (março/abril): a mais emblemática de Portugal, procissões centenárias.
- Braga Romana (final de maio): recriação histórica de Bracara Augusta.
- São João de Braga (junho, ponto alto na noite de 23 para 24): festas da cidade.
- Noite Branca (início de setembro): arte e animação noturna.
- Confirmar datas exatas em https://visitbraga.travel.

## GASTRONOMIA
- Braga tem gastronomia e doçaria próprias. Os detalhes validados estão no módulo de doces/gastronomia; se não o tiveres carregado, dá só uma ideia geral e NÃO inventes descrições, ingredientes nem onde comprar.
